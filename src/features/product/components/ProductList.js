...
export default function ProductList() {
  ...
  const useBrands = useSelector(selectBrands)
  const useCategories = useSelector(selectCategories)
  const filters = [
    {
      id: "brand",
      name: "Brand",
  ...
  return (
    <div>
      <div className="bg-white">
        <div>
          <MobileFilter mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen} handleFilters={handleFilters} filters={filters}/>
...
function MobileFilter({mobileFiltersOpen,setMobileFiltersOpen,handleFilters, filters}) {
  return (
    <>
